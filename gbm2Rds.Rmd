...
```{r load data}
genome <- "GRCh38"
pipestance_path <- "/Users/bernd/Downloads/"
pipestance_path <- "/Volumes/collanto/scSolenne-1/jim-fasta/test"
...
tsne.data$dbCluster = analysis_results$clustering$kmeans_10_clusters$Cluster-1
