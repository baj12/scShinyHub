...
```{r mandar7.18}
pipestance_paths <- c("~/Downloads/New Folder With Items/vdj_raw_gene_bc_matrices",
                      "~/Downloads/New Folder With Items/v3_raw_feature_bc_matrix/outs/raw_gene_bc_matrices/",
                      "~/Downloads/New Folder With Items/v2_raw_feature_bc_matrix/outs/raw_gene_bc_matrices/")
...
gbm <- load_cellranger_matrix(pipestance_path,barcode_filtered = FALSE)
...
save(file = "pbmc10x.Rds", list = c("featuredata", "gbm"))
