...
if (is.null(input$dgeClustersSelection)) {
  input$dgeClustersSelection <- "0"
  print("Warning: setting dgeClustersSelection to All")
}
...
if (is.null(input$clusterSelectionPanelPlot)) {
  input$clusterSelectionPanelPlot <- "All"
...
Creating `r input$tsneDim` tSNE clusters.
