...
```{r setup, include=TRUE, echo=FALSE, warning=FALSE, eval=FALSE}
# not needed anymore
# input <- params
...
```{r inputData, echo=FALSE, eval=TRUE}
...
```{r useCells, echo=FALSE, eval=FALSE}
# not needed anymore
...
```{r useGenes, echo=FALSE, eval=FALSE}
# not needed anymore
...
```{r medianENSG, echo=FALSE, eval=TRUE}
medianENSG <- medianENSGfunc(as.matrix(assays(scEx)[[1]]))
```


```{r medianUMI, echo=FALSE, eval=TRUE}
...
```{r pca, eval=TRUE, echo=FALSE, eval=FALSE}
# not needed anymore
...
```{r scran_Cluster, echo=FALSE, eval=FALSE}
