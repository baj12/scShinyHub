...
useCells = useCellsFunc(dataTables, geneNames, rmCells, rmPattern, keepCells)
```
...
set.seed(seed = seed)
prioritized_genes =    prioritize_top_genes(gbm, as.numeric(as.character(tsne.data$dbCluster)), "sseq",
                                            logscale = FALSE, 
                                            min_mean=0.5, 
                                            p_cutoff=0.05,
                                            order_by='pvalue')
