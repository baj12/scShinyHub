...
if(DEBUG)cat(file=stderr(), "output$gene_vio_plot\n")
  save(file = "~/scShinyHubDebug/bj-DE-gene_vio_plot.RData", list = c("scCells", "scCL", "sc", ls()))
# load(file = "~/scShinyHubDebug/bj-DE-gene_vio_plot.RData")
...
```{r bj-DE-scater, eval=TRUE, echo=FALSE, warning=FALSE }
