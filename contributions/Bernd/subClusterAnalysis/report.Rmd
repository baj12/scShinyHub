...
## Plot 1
  ...
  x1 = `r input$dimension_x1`
  
  y1 = `r input$dimension_y1`
  
  c1 = `r input$clusters1`
...
save(file = "~/scShinyHubDebug/dge.rep2.RData", 
