...
```{r bj-cellRanger-table, echo=FALSE, warning=FALSE, error=FALSE}
require("forcats")
require("tidyverse")
...
# save full table in tmp folder to be included in report
  write.csv(dt, file = paste0(input$reportTempDir, "/crSignificantGenes.csv"))
...
Full table can be found here: file://crSignificantGenes.csv
